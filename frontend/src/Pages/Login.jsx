...
const Login = () => {
    ...
    return (
        <Box>
            ...
            {message === "invalid credentials" && screenSize.width>640 || message === "invalid credentials" && screenSize.width>640 ? <Text textAlign={'center'} mt={{ sm: "10px", md: "10px", base: "10px", lg: "160px", xl: "160px" }} fontSize={'15px'} color={'red'}>Invalid Credentials</Text> : null}
            <br />
        </Box>
    );
};
